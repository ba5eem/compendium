...
drone(
    ...
    >> moveToChanged(status="DONE")
    >> casey(moveTo(21.371518652227294, -157.7116182859902, 15, MoveTo_Orientation_mode.TO_TARGET, 0.0))
    >> donatello(moveTo(21.371518652227294, -157.7116182859902, 15, MoveTo_Orientation_mode.TO_TARGET, 0.0))
    >> moveToChanged(status="DONE")
