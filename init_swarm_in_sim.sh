...
V=1 sphinx coconut.world april.drone::stolen_interface=::simple_front_cam=false casey.drone::stolen_interface=::simple_front_cam=false donatello.drone::stolen_interface=::simple_front_cam=false leonardo.drone::stolen_interface=::simple_front_cam=false michelangelo.drone::stolen_interface=::simple_front_cam=false raphael.drone::stolen_interface=::simple_front_cam=false splinter.drone::stolen_interface=::simple_front_cam=false
